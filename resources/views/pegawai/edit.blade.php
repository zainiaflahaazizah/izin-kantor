                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="card-title">Formulir Pengajuan Izin Keluar Kantor</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="nim">NIP BPS</label>
                                            <input type="text" id="nip_bps" name="nip_bps" class="form-control" placeholder="Masukkan NIP BPS Anda" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="nim">Wilayah</label>
                                            <input type="text" id="wilayah" name="wilayah" class="form-control" placeholder="Masukkan Wilayah Anda" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="status" name="status" class="form-control" placeholder="Masukkan Status Anda" required>
                                        </div>

                                         <div class="form-group">
                                            <label for="pendidikan">Pendidikan</label>
                                            <input type="text" id="pendidikan" name="pendidikan" class="form-control" placeholder="Contoh: S1, D3, SMA" required>
                                        </div>
                        ...
                        <div class="card-action  d-flex justify-content-end">
                            <button type="submit" form="izinForm" class="btn btn-success">Simpanton>
